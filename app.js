                    ...
                    <div class="nc-evidence">
                      ...
                      <div class="evidence-grid">
                        <div class="evidence-photo-actions">
                          ...
                          <label class="camera-drop is-gallery">${svgIcon("document")} Escolher da galeria <small>Arquivo de foto até 50 MB</small><input type="file" accept="image/*" data-evidence-file="${question.id}" data-capture-method="gallery" hidden /></label>
                        </div>
...
document.addEventListener("change", (event) => {
  ...
  if (responsibleEvidence?.files?.[0]) {
    ...
    if (file.size > 50 * 1024 * 1024) {
      setOfflineNotice({ phase: "error", message: "A evidência deve ter no máximo 50 MB." });
      return;
    }
